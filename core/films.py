...
FILMS = [
    ...
    },
    {
        ...
        "prompt": ("A cinematic travel movie scene: warm evening light over the lively "
                   ...
                   "ABSOLUTELY NO Vietnamese text and no text in ANY language anywhere in the scene: every signboard, shop sign, banner, house plaque and number plate on the old houses is completely BLANK painted wood — no shop names, no house numbers, no lettering of any kind (AI-generated Vietnamese text comes out misspelled, so none may appear). "
...
DUO = {
    ...
    "hoian": (
        ...
        "background. ABSOLUTELY NO Vietnamese text and no text in ANY language anywhere in the scene: every signboard, shop sign, banner, house plaque and number plate on the old houses is completely BLANK painted wood — no shop names, no house numbers, no lettering of any kind (AI-generated Vietnamese text comes out misspelled, so none may appear). "

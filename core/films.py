...
FILMS = [
    ...
    },
    {
        ...
        "prompt": ("A cinematic adventure-movie scene: ancient jungle temple ruins, shafts of "
                   ...
                   "the edge of a deep chasm with a single hanging vine. They cross TOGETHER "
                   "on that ONE vine, comically: the WOMAN of the two grips the vine firmly "
                   "with both hands and does the actual swinging, calm and capable, while the "
                   "MAN of the two wraps both arms tightly around her and clings on for dear "
                   "life, legs kicking in the air, eyes squeezed shut, SCREAMING with comic "
                   "terror the whole way across — a wordless scream or plain English words "
                   "only, never any other language — the vine and her grip visibly carry both "
                   "their weight. They land together on two feet on the far side, knees "
                   "bending to absorb it, the man still clinging a second too long before "
                   "letting go sheepishly. They rise together before a stone altar; the "
